...
let domainRegexp = RegExp(/^[a-zA-Z0-9]{1,61}[a-zA-Z0-9]{2,}$/);
...
class signUp extends Component {
    ...
    handleChange = e => {
        ...
        switch (name) {
            case 'webSiteName':
                ...
                ? this.setState(state => ({ ...state,errors: { ...state.errors,webSiteName: "" } })) : this.setState(state =>({ ...state,errors: { ...state.errors,webSiteName: "*Enter the valid name of your site e.g. aca.am" } }))
                break;

            case 'company':
                value.length > 0
                ? this.setState(state => ({ ...state,errors: { ...state.errors,company: "" } })) : this.setState(state =>({ ...state,errors: { ...state.errors,company: "*Enter the valid name of your company" } }))
                break;

            case 'phoneNumber':
                value.length > 0 && !isNaN(value)
                ? this.setState(state => ({ ...state,errors: { ...state.errors,phoneNumber: "" } })) : this.setState(state =>({ ...state,errors: { ...state.errors,phoneNumber: "*Enter valid phone number e.g" } }))
                break;
    ...
    signUp = (e) => {
        ...
        ["webSiteName"," company","phoneNumber","email","password"].forEach(key => {
            if (["webSiteName"," company","phoneNumber","email","password"].every((k)=>!this.state.errors[k])) { 
                fire
                .auth()
                    ...
                    <div className="FormCenter">
                        <div className="FormField">
                            ...
                            <input type="text"
                                ...
                                placeholder="Website URL e.g. aca"
                                name="webSiteName"
                                pattern="[a-z]{1,15}"

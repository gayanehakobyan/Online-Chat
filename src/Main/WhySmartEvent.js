        ...
        return (
            <div id="whySmartEvent">
                <p style={{color:"#5C3C79",fontSize: "calc( 25px + 3vw )",fontWeight: "1000",margin:"5vw"}}>
                    <span style={{fontWeight: "50"}}><i>Why</i></span> Smart <span style={{fontWeight: "50"}}><i>event</i></span> ?
                </p>
                <div style={{ display: "inline-block", margin: "35px", }}><img src={require("../Image/WhySmartEvent/icon1.png")} alt="icon"  style={{height: heightIndex, transition:'height 2s ease-out'}}/><h2>Customer Support</h2></div>
                <div style={{ display: "inline-block", margin: "35px" }}><img src={require("../Image/WhySmartEvent/icon2.png")} alt="icon"  style={{height: heightIndex, transition:'height 2s ease-out'}}/><h2>Live Chat </h2></div>
                <div style={{ display: "inline-block", margin: "35px" }}><img src={require("../Image/WhySmartEvent/icon3.png")} alt="icon"  style={{height: heightIndex, transition:'height 2s ease-out'}}/><h2>Make it personal</h2></div>
            </div>
        )
    }
}

...
class Footer extends Component{
    render(){
        ...
        return(
            <div className='footerSection py-6 w-screen max-h-16 min-h-24' >
                <div className=" mx-auto px-6 table w-full ">
                        <div className="block sm:table-cell min-w-full" style={{width : "25%"}}> 
                            ...
                            <List>
                                    <Link to='/' className="footerElement text-grey hover:text-grey-dark" >Home</Link> 
                                </List>
                                <List>
                                    <Link to='/aboutSmartEvent' className="footerElement text-grey hover:text-grey-dark">About Smart Event</Link>
                                </List>
                                <List>
                                    <a href="#" className="footerElement text-grey hover:text-grey-dark" >Empty</a>
                            </List>
                            </ul>
                        </div>
                        <div className="block sm:table-cell min-w-full" style={{width : "25%"}}>
                            ...
                            <ul className="list-reset text-xs mb-6">
                                <List>
                                    <Link to='/product' className="footerElement text-grey hover:text-grey-dark" >Prodact1</Link>
                                </List>
                                <List>
                                    <Link to='/product' className="footerElement text-grey hover:text-grey-dark">Prodact2</Link>
                                </List>
                                <List>
                                    <Link to='/product' className="footerElement text-grey hover:text-grey-dark" >Prodact3</Link>
                                </List>                  
                            </ul>
                        </div>
                        <div className="block sm:table-cell min-w-full" style={{width : "25%"}}>
                            ...
                            <ul className="block items-center list-reset text-xs mb-6">
                                <List>
                                    <Link to='/partner'  className="footerElement text-grey hover:text-grey-dark">Partner 1</Link>
                                </List>
                            <List>
                                    <Link to='/partner'  className=" footerElement text-grey hover:text-grey-dark">Partner 2</Link>
                            </List>
                            <List>
                                    <Link to='/partner'  className="footerElement text-grey hover:text-grey-dark" >Partner 3</Link>
                            </List>               
                            </ul>
                        </div>
